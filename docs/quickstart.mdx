...
1. Use our [Quick start Python notebook](https://github.com/elastic/vector-gen-ai/blob/main/notebooks/search/00-quick-start.ipynb) for a concrete, interactive example of indexing and searching with ((es)).
This doesn't require any local setup.similar
...
In this example, we assume you are using the [Elastic Cloud](https://cloud.elastic.co) and have a Cloud ID and password.

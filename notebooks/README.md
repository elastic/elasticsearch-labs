...
- [`context`](./context/): Notebooks that demonstrate context management for agents with Elasticsearch, like generating and retrieving Knowledge Indicators (KIs) from AI Indices.

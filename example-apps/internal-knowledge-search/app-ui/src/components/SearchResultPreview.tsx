...
const SearchResultPreview: React.FC<SearchResultModel> = ({
                                                                     title,
                                                                     created,
                                                                     dataSource,
                                                                     dataSourceImagePath,
        ...
        <div
            ...
            <div className="flex justify-between items-center mb-4">
                <div className="text-sm text-gray-500">
                    <span className="font-bold">Created:</span> {new Date(created).toLocaleDateString()}
                </div>
                <span
                    className="flex items-center text-gray-800 border border-gray-400 px-3 py-1 text-xs rounded font-semibold">
                    {dataSourceImagePath && (
                        <><img src={dataSourceImagePath} alt="Description" className="w-4 h-4 mr-2"/><span
                            className="border-l border-gray-800 mx-2 h-4"></span></>
                    )
                    }
